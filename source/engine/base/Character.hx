...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf':
				...
				addOffset('idle', 170, 46);
				addOffset("singUP", 120, 70);
				addOffset("singRIGHT", 150, 51);
				addOffset("singLEFT", 180, 48);
				addOffset("singDOWN", 190, 54);
				addOffset("singUPmiss", 130, 70);
				addOffset("singRIGHTmiss", 130, 54);
				addOffset("singLEFTmiss", 180, 45);
				addOffset("singDOWNmiss", 226, 39);
	...
	override function update(elapsed:Float)
	{
		if (!curCharacter.startsWith('bf'))
		{
			...
			if (curCharacter == 'dad')
				dadVar = 6.1;
			if (holdTimer >= engine.functions.Conductor.stepCrochet * dadVar * 0.001)
			{
				dance();
				holdTimer = 0;
			}
